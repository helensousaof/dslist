...
public class Game {
	...
	public Game(Long id, String title, Integer year, String genre, String platform, Double score, String imgUrl,
			String shortDescription, String longDescriprion) {
	...
	public String getLongDescriprion() {
		return longDescriprion;
	}

	public void setLongDescriprion(String longDescriprion) {
		this.longDescriprion = longDescriprion;
	}
